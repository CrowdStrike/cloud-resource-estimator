...
audit_AWS(){
  # AWS audit
  curl -o aws_count.py https://raw.githubusercontent.com/CrowdStrike/Cloud-Benchmark/main/aws-cspm-benchmark.py
...
audit_Azure(){
  # Azure audit
  curl -o azure_count.py https://raw.githubusercontent.com/CrowdStrike/Cloud-Benchmark/main/azure-cspm-benchmark.py
